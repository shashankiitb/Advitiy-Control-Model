...
time = np.linspace(t0,tf,N,endpoint=True)
...
for  i in range(0,N-1):
	...
	Advitiy.setDisturbance_b(0*v_torque_total_b)
	m_torque_dist[i,:] = v_torque_total_b.copy()

	Advitiy.setControl_b(cont.detumW(Advitiy,m_w_BO_b[i,:]))
