...
G=qo.quatMultiplynorm(m1,m2)
if (G == m9).all() == 0:
	flag=0

G=qo.quatMultiplynorm(m3,m2)
if (G == m10).all() == 0:
	flag=0

G=qo.quatMultiplynorm(m4,m5)
if (G == m11).all() == 0:
	flag=0

G=qo.quatMultiplynorm(q9,q9)
if (G == q9).all() == 0:
	flag=0
...
G=qo.quatMultiplyunnorm(m1,m2)
if (G == m6).all() == 0:
	flag=0

G=qo.quatMultiplyunnorm(m3,m2)
if (G == m7).all() == 0:
	flag=0

G=qo.quatMultiplyunnorm(m4,m5)
if (G == m8).all() == 0:
	flag=0

G=qo.quatMultiplyunnorm(q9,q9)
if (G == q9).all() == 0:
	flag=0
