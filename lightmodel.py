...
for i in range(N):
    v_pos_i = sgp_output[i,1:4].copy()  #position of satellite in ECI
    v_sun_i = si_output[i,1:4].copy()   #sun vector in ECI
    ...
    light_output[i,0] = T[i]
    light_output[i,1] = flag
