...
state3 = np.array[];
state4 = np.array[];
state1[0:8]=np.array([1,0,0,0,10,0,0,0]) 
state2[0:8]=np.array([2,0,0,0,20,0,0,0])
state3[0:8]=np.array([1.1,0.1,0.1,0.1,10,0,0,0])
state4[0:8]=np.array([1.2,0.2,0.2,0.2,20,0,0,0])
