...
m_test_lightmodel_output = np.genfromtxt(r'D:\Shashank\Advitiy-Control-Model-detumbling\light_output.csv', delimiter=',')
...
class TestAdd(unittest.TestCase):
	...
	def test_cases_file(self,value):
		time = value[0]
		expected = value[1]
		result = m_test_lightmodel_output[time*10,1]
